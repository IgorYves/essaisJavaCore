 ...
 * 
 *  2do encryption avec string fournis par user
 *  	maybe un algorytme simple de "vrais" encryption
 */
/**
...
public class CriptoV0 {
	private static char[] abc = new char[52];
	/**
	 * @param args
	 */
